...
LastEditTime : 2022-09-19 08:51:04
Description  : config load function ref:https://github.com/open-mmlab/mmcv/blob/master/mmcv/utils/config.py
FilePath     : /DLAN/dlan/utils/config.py
'''
import os
...
def get_config(fname, overrides=None, show=True):
    ...
    logger = setup_logger(
        ...
        logging_pkg=config.log_config.logging_pkg)
